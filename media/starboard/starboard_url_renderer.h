...
#ifndef MEDIA_STARBOARD_STARBOARD_URL_RENDERER_H_
#define MEDIA_STARBOARD_STARBOARD_URL_RENDERER_H_
...
// owned by StarboardUrlRendererWrapper and must live on a single
// thread/process/TaskRunner, usually Chrome_InProcGpuThread.
class MEDIA_EXPORT StarboardUrlRenderer : public Renderer,
                                          private SbPlayerBridge::Host {
 public:
  StarboardUrlRenderer(
  ...
  StarboardUrlRenderer(const StarboardUrlRenderer&) = delete;
  StarboardUrlRenderer& operator=(const StarboardUrlRenderer&) = delete;

  ~StarboardUrlRenderer() override;
...
#endif  // BUILDFLAG(IS_ANDROID)
  void SetStarboardUrlRendererCallbacks(
 ...
 private:
  ...
  base::WeakPtrFactory<StarboardUrlRenderer> weak_factory_{this};
};

}  // namespace media

#endif  // MEDIA_STARBOARD_STARBOARD_URL_RENDERER_H_
